...
import { EventClaimsDetailsRoutingModule } from './EventClaimsDetails-routing.module';
...
@NgModule({
  imports: [
    NgxPaginationModule,
    MatSnackBarModule,
    EventClaimsDetailsRoutingModule,
    CardModule,
    BaseModule ,
    NavModule,
    IconModule,
...
export class EventClaimsDetailsModule {
}
